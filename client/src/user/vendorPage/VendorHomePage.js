...
const VendorHomePage = () => {
  ...
  const [newProduct, setNewProduct] = useState({ name: '', price: '', stock: '', category: '', id: '', image: null, accountNumber: null});
  ...
  const handleAddProduct = (event) => {
    ...
    formData.append('accountNumber', newProduct.accountNumber)
    ...
    setNewProduct({ name: '', price: '', stock: '', id: '', category: '', image: null, accountNumber: null });
    setShowModal(false);
  };
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg">
            ...
            <div className="mb-4">
              ...
              <input
                type="text"
                name="accountNumber"
                value={newProduct.accountNumber}
                onChange={handleInputChange}
                className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-blue-500"
              />
            </div>
